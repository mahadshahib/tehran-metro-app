    ...
    var body: some View {
        ...
        return NavigationStack {
            List {
                ...
                Section(header: SectionHeaderLabel(Loc.language.string(for: lang))) {
                ...
                Section(header: SectionHeaderLabel(Loc.appearance.string(for: lang))) {
                ...
                Section(header: SectionHeaderLabel(Loc.nameDisplay.string(for: lang))) {
