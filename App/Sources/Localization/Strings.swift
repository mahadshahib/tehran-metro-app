...
enum Loc {
    ...
    static let transferTo = LocalizedText(en: "Transfer to", fa: "تعویض به")
    static let arrive = LocalizedText(en: "Arrive", fa: "مقصد")
    static let depart = LocalizedText(en: "Depart", fa: "مبدأ")
    static let routeSteps = LocalizedText(en: "Route", fa: "مسیر")
    static let showStations = LocalizedText(en: "Show all stations", fa: "نمایش همه ایستگاه‌ها")
    static let hideStations = LocalizedText(en: "Hide stations", fa: "پنهان کردن ایستگاه‌ها")
